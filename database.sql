...
INSERT INTO `game_status` VALUES ('inactive',NULL,NULL,NULL);
...
INSERT INTO `players` VALUES (NULL,'O',NULL,NULL),(NULL,'X',NULL,NULL);
...
--
/*!50003 DROP PROCEDURE IF EXISTS `check_abort` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `check_abort`()
BEGIN
	UPDATE game_status SET `status`='aborted', p_turn=NULL, result=if(p_turn='O','X','O'), last_change=NULL WHERE p_turn IS NOT NULL and last_change < (now()-INTERVAL 5 MINUTE);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2021-01-06  0:18:16
